...
# Clean Gadget
# According to https://github.com/johnb110/VDPython:
...
def main(raw_path="", store_path=""):
    current_dir = Path(__file__).resolve().parent
    raw_path = current_dir / "function.json"
    store_path = current_dir/ "nor_devignset.json"
    normalize_code_csv(raw_path, store_path)
